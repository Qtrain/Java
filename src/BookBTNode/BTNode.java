...
public class BTNode<E> {
   // Invariant of the BTNode<E> class:
     ...
     * node--this reference may be null to indicate that there is no node after
     * this new node.
     * @param <CODE>initialRight</CODE> a reference to the right child of this
     * new node--this reference may be null to indicate that there is no node
     * after this new node.
   ...
   *
     ...
     * the deepest node that can be reached by following left links). The return
     * value is a reference to the root of the new (smaller) tree. This return
     * value could be null if the original tree had only one node (since that
   ...
   *
     ...
     * the left child of this node (or the null reference if there is no left
     * child for this node)
     * <dt><b>Postcondition:</b><dd>
     * The link to the left child of this node has been set to
     * <CODE>newLeft</CODE>. Any other node (that used to be the left child) is
   ...
   *
     ...
     *
     * @param <CODE>newLeft</CODE> a reference to the node that should appear as
     * the right child of this node (or the null reference if there is no right
     * child for this node)
     * <dt><b>Postcondition:</b><dd>
     * The link to the right child of this node has been set to
     * <CODE>newRight</CODE>. Any other node (that used to be the right child)
     * is no longer connected to this node.
   *
     */
     ...
     * will be copied (which may be an empty tree where <CODE>source</CODE> is
     * null)

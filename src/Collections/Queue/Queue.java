...
public class Queue<Item> implements Iterable<Item> {
    ...
    // helper linked list class.  This is only used within the Queue Class which is 
    //why it is private;
 ...
 class QueueClient {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println("Using iterator to show items in Q");
        System.out.println("---------------------------------");
        //how to use iteration.  Use a for each loop
        for (String s : people){
            System.out.println(s);
        }
        System.out.println("");
        //for each loop is basically shorthand for a while statement
        System.out.println("While Iteration");
        System.out.println("----------------");
        Iterator<String> i = people.iterator();
        while(i.hasNext()){
            String s = i.next();
            System.out.println(s);
        }

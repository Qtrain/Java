...
public class GenericNode<Type> {
   ...
   **/   
    public GenericNode(Type genericType, GenericNode initialLink) {
        data = genericType;
        link = initialLink;
    }
     ...
     * @param newData 
     */
    public void setData(Type newData) {
        data = newData;
    }
   ...
   **/
    public void addNodeAfter(Type type) {
        link = new GenericNode(type, link);
        //data++;
    }
   ...
   **/   
    public static <Type> int listLength(GenericNode <Type> head) {
   ...
   *   returned.     
   **/ 
    public  static <Type> GenericNode <Type> listSearch(GenericNode<Type> head, Type target) {
        GenericNode<Type> cursor;
   ...
   **/   
    public static <Type> GenericNode <Type> listPosition(GenericNode<Type> head, int position) {
        GenericNode<Type> cursor;
        int i;
   ...
   **/ 
    public static <Type> GenericNode <Type> listCopy(GenericNode<Type> source) {
        
        //Why aren't we declaring these as fields at the top of the class
        GenericNode<Type> copyHead;
        GenericNode<Type> copyTail;
        ...
        copyHead = new GenericNode(source.data, null);
        copyTail = copyHead;
   ...
   *   Indicates that there is insufficient memory for the new list.   
   **/
    public static <Type> GenericNode[] listCopyWithTail(GenericNode <Type> source) {
        GenericNode<Type> copyHead;
        GenericNode<Type> copyTail;
        GenericNode[] answer = new GenericNode[2];
    ...
    public void printList(GenericNode <Type> head) {
        GenericNode <Type> cursor;
        int count = 0;
        //COUNTING THE NODES!
        for (cursor = head; cursor != null; cursor = cursor.link) {
...
//    }
   ...
   *   Indicates that there is insufficient memory for the new list.    
   **/   
    public static <Type> Object[] listPart(GenericNode <Type>  start, GenericNode <Type> end) {
        ...
        copyHead = new GenericNode(start.data, null);
        copyTail = copyHead;
        cursor = start;

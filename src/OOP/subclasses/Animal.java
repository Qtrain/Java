...
public class Animal extends Organism {
     ...
     * weekly eating need.
     *
     * @param <CODE>initSize</CODE> the initial size of this
     * <CODE>Animal</CODE>, in ounces
     * @param <CODE>initRate</CODE> the initial growth rate of this
     * <CODE>Animal</CODE>, in ounces
     * @param <CODE>initNeed</CODE> the initial weekly eating requirement of
     * this <CODE>Animal</CODE>, in ounces per week
     * <dt><b>Precondition:</b><dd>
     * <CODE>initSize >= 0</CODE> and <CODE>initNeed >= 0</CODE>. Also, if
     * <CODE>initSize</CODE> is zero, then <CODE>initRate</CODE> must also be
     * zero.
     * <dt><b>Postcondition:</b><dd>
     * This <CODE>Animal</CODE> has been initialized. The value returned from
     * <CODE>getSize()</CODE> is now <CODE>initSize</CODE>, the value returned
     * from <CODE>getRate()</CODE> is now <CODE>initRate</CODE>, and this
     * <CODE>Animal</CODE> must eat at least <CODE>initNeed</CODE> ounces of
     * food each week to survive.
     * @exception IllegalArgumentException Indicates that <CODE>initSize</CODE>,
     * <CODE>initRate</CODE>, or <CODE>initNeed</CODE> violates the
     * precondition.
   *
     */
     ...
     *
     * @param <CODE>amount</CODE> the amount of food for this
     * <CODE>Animal</CODE> to eat (in ounces)
     * <dt><b>Precondition:</b><dd>
     * <CODE>amount >= 0.</CODE>
     * <dt><b>Postcondition:</b><dd>
     * The given amount (in ounces) has been added to the amount of food that
     * this <CODE>Animal</CODE> has eaten this week. throw
     * IllegalArgumentException Indicates that <CODE>amount</CODE> is negative.
   *
     */
     ...
     * week.
     *
     * @return the total amount of food that this <CODE>Animal</CODE> needs to
     * survive one week (measured in ounces)
   *
     */
     ...
     * <CODE>Animal</CODE>.
     *
     * @param <CODE>newNeed</CODE> the new weekly food requirement for this
     * <CODE>Animal</CODE> (in ounces)
     * <dt><b>Precondition:</b><dd>
     * <CODE>newNeed >= 0.</CODE>
     * <dt><b>Postcondition:</b><dd>
     ...
     * <CODE>newNeed</CODE>.
     * @exception IllegalArgumentException Indicates that <CODE>newNeed</CODE>
     * is negative.
   *
     */
     ...
     * zero. Also, if this <CODE>Animal</CODE> has eaten less than its need over
     * the past week, then <CODE>expire</CODE> has been activated.
   *
     */
     ...
     *
     * @param - none
     * @return the ounces of food that this <CODE>Animal</CODE> still needs to
     * survive this week (which is the total need minus the amount eaten so
     * far).
   *
     */

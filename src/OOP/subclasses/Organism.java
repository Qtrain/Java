...
/**
 * ****************************************************************************
 * An <CODE>Organism</CODE> object simulates a growing organism such as a plant
 * or animal.
 * 
...
public class Organism {
     ...
     * @throws IllegalArgumentException Indicates that <CODE>initSize</CODE> or
     * <CODE>initRate</CODE> violates the precondition.
   *
     */
     ...
     *
     * @param <CODE>amount</CODE> the amount to increase or decrease the size of
     * this <CODE>Organism</CODE> (in ounces)
     * <dt><b>Postcondition:</b><dd>
   ...
   *
     ...
     * @param - none
     * <dt><b>Postcondition:</b><dd>
     * The size and growth rate of this <CODE>Organism</CODE> have been set to
     * zero. 
   *
     */
    public void expire() {
     ...
     *
     * @param - none
     * @return the growth rate of this <CODE>Organism</CODE> (in ounces per
     * week)
   *
     */
     ...
     *
     * @param - none
     * @return the current size of this <CODE>Organism</CODE> (in ounces)
   *
     */
     ...
     *
     * @param - none
     * @return If this <CODE>Organism</CODE>’s current current size is greater
     * than zero, then the return value is <CODE>true</CODE>; otherwise the
   ...
   *
     ...
     *
     * @param <CODE>newRate</CODE> the new growth rate for this
     * <CODE>Organism</CODE> (in ounces per week)
     * <dt><b>Precondition:</b><dd>
     ...
     * <CODE>newRate</CODE>.
     * @throws IllegalArgumentException Indicates that the size is currently
     * zero, but the <CODE>newRate</CODE> is nonzero.
   *
     */
    public void setRate(double newRate) {
        if ((size == 0) && (newRate != 0)) {
            throw new IllegalArgumentException("newRate must be zero (because current size is zero");
        }
        rate = newRate;
    }
